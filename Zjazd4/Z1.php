...
<?php
    ...
    function login($username, $password)
    {
        ...
        setcookie("username", $username, time() + (86400 * 30), "/"); // Ustawienie ciasteczka na 30 dni
    }
    ...
    function logout()
    {
        session_unset();
        session_destroy();
        setcookie("username", "", time() - 3600, "/"); // Usunięcie ciasteczka
    }
    ...
    // Wyświetlenie komunikatu o braku dostępu
    function showAccessDeniedMessage()
    {
        echo '<h2>Brak dostępu</h2>';
        echo '<p>Nie masz uprawnień do korzystania z tej części strony.</p>';
        echo '<p>Zaloguj się, aby uzyskać dostęp.</p>';
    }

    // Logika logowania i wylogowania
